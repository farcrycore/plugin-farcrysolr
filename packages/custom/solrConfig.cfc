<cfcomponent displayname="Solr Config Utility" hint="Configuration bean for solr plugin." output="false">
	...
	<cfproperty name="storagePath" displayname="Storage Path" hint="solr collection storage path; file path from drive." type="string" default="/Applications/ColdFusion9/collections" />
